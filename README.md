...
```
cd existing_repo
git remote add origin http://localhost:8888/root/springboot2prj.git
git branch -M main
...
- [ ] [Set up project integrations](http://localhost:8888/root/springboot2prj/-/settings/integrations)
